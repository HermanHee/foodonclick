        ...
        <div class="container-fluid px-0">
            ...
            <div class="collapse navbar-collapse w-100  justify-content-center w-100" id="navbarNavDropdown">
                <ul class="navbar-nav mr-auto">
					<li>
						<a class="nav-link" href="adminManageUsers.php" >Manage Users<span class="sr-only"></span></a>
					</li>
					<li>
					   <a class="nav-link" href="adminAddUser.php" >Add User<span class="sr-only"></span></a>
					</li>
					<li>
